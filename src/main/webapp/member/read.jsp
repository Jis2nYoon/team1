...
<DIV class='content' > 
  ...
  <ASIDE style='float: right;'>
    ...
    <span class='menu_divide' >│</span> 
    <A href='./list.do?col=${param.col }&word=${param.word}&nowPage=${param.nowPage}'>목록</A>
  </ASIDE> 
  ...
  <FORM name='frm' id='frm' method='POST' action='./update.do' 
    ...
    <div class="form-group">
      <label for= "email" class="col-md-2 control-label">이메일</label>    
       <div class="col-md-10">
       <input type='text' class="form-control input-md" name='email' id=email value=' ${memberVO.email }'  required="required" style='width: 30%;' readOnly>
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" onchange="changeNickname()" name='nickname' id='nickname' value='${memberVO.nickname }' required="required" style='width: 30%;' placeholder="닉네임" >
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='address1' id='address1' 
                   value='${memberVO.address1 }'  style='width: 80%;' placeholder="주소">
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='address2' id='address2' 
                   value='${memberVO.address2 }'  style='width: 80%;' placeholder="상세 주소">
      </div>
    </div>   
...
<!-- ----- DAUM 우편번호 API 종료----- -->
    ...
    <div class="form-group">
      <div class="col-md-offset-2 col-md-10">
        ...
        <button type="button" onclick="location.href='./cancel.do?memberno=${sessionScope.memberno}'" class="btn btn-primary btn-md">회원탈퇴</button>
