...
<DIV class='content'>   
  ...
  <form name='frm' id='frm' method="get" action="./send_list_search_paging.do">
 ...
 <div class="btn-group">
  <button type="button" class="btn btn-info" onclick="location.href='receive_list_search_paging.do?memberno=${param.memberno}&contentsno=${param.contentsno }'">받은 쪽지</button>
  <button type="button" class="btn btn-info" onclick="location.href='#'">보낸 쪽지</button>
  </div>
</DIV>
        ...
        <c:forEach var="mem_MsgVO" items="${list }">
          <tr> 
            ...
            <td style='text-align: center;'>
              ...
              <a href="./delete_msg.do?msgno=${mem_MsgVO.msgno }&check=2&memberno=${param.memberno}&contentsno=${param.contentsno }"><span class="glyphicon glyphicon-trash" title="삭제"></span></A>
            </td>
          </tr>
        </c:forEach>
