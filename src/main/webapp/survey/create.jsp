...
<FORM name='frm' method='POST' action='./create.do' class="form-horizontal">
     ...
     <div class="form-group">
        ...
        <div class="col-md-5">
          <input type='text' class="form-control input-lg" name='title' id='title' value='' required="required" style='width: 80%;'>
        </div>
      </div>  
     ...
     <div class="form-group">   
        ...
        <div class="col-md-5">
          <textarea name='content' class="form-control input-lg"  id='content' rows='10' required="required" ></textarea>
        </div>
      </div>  
