    ...
    <FORM name='frm' method='POST' action='./create.do'
      ...
      <div class="form-group">   
        ...
        <div class="col-md-11">
          ...
          value='' placeholder="질문 제목" required="required" style='width: 100%;'>
        </div>
      </div>
      <div class="form-group">   
        <label for="content" class="col-md-1 control-label">내용</label>
        <div class="col-md-11">
          <textarea class="form-control input-lg" name='content' id='content' 
          placeholder="궁금하신 내용을 자세히 적어주세요."  rows='10'></textarea>
        </div>
      </div>
      <div class="form-group">   
      ...
      <div class="checkbox" style='text-align: right;'>
        <label for="secreat">
          <input type="checkbox" name='secreat' id='secreat' value=''>비밀글
        </label>
      </div> 
      <br>
